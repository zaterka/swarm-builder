"""Validation gate for the linear spike, custom-baseURL model path
(PLAN.md Phase 5, codegen contract).
...
def main() -> None:
    ...
    print("ALL CHECKS PASSED (linear, custom-baseURL model path)")
