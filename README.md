...
`uv sync` inside Phase 5. See [`docs/api.md`](docs/api.md#compile-endpoints)
...
[`docs/architecture.md`](docs/architecture.md#model-route-inheritance-and-the-two-emission-paths).
...
specified precisely in [`docs/api.md`](docs/api.md#sse-event-stream).
...
[`docs/architecture.md`](docs/architecture.md#marker-regions-and-the-two-tier-boundary-check).
...
[`docs/api.md`](docs/api.md#sse-event-stream).
...
- **The ring-buffer-gap recovery is implemented in the client, deliberately as
  ...
  comment frame. See [`docs/api.md`](docs/api.md#last-event-id-and-reconnecting)
...
- [`docs/api.md`](docs/api.md) — every endpoint, status code, and the SSE
  framing and reconnect contract.
- [`docs/architecture.md`](docs/architecture.md) — the graph document schema
